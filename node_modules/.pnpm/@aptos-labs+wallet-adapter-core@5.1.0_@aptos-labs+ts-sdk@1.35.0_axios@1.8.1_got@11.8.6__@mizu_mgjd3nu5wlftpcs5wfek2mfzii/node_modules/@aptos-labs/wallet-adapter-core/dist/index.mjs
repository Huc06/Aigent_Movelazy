// src/version.ts
var WALLET_ADAPTER_CORE_VERSION = "5.1.0";
...
var WalletCore = class extends EventEmitter {
  ...
  async connect(walletName) {
    ...
    if (this.redirectIfRedirectable(selectedWallet))
      return;
  ...
  redirectIfRedirectable(selectedWallet) {
    var _a, _b;
    if (isRedirectable()) {
      if (selectedWallet.readyState === "Installed" /* Installed */) {
        if ((_a = selectedWallet.features["aptos:openInMobileApp"]) == null ? void 0 : _a.openInMobileApp) {
          (_b = selectedWallet.features["aptos:openInMobileApp"]) == null ? void 0 : _b.openInMobileApp();
          return true;
        }
      }
      if (selectedWallet.readyState === "NotDetected" /* NotDetected */) {
